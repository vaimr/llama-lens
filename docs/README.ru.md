...
|  | [01-需求文档.en.md](01-需求文档.en.md) · [01-需求文档.ru.md](01-需求文档.ru.md) | Переводы требований |
| Архитектура | [02-架构设计文档.md](02-架构设计文档.md) | Архитектура, коллекторы, модель данных, API, развёртывание (китайский) |
|  | [02-架构设计文档.en.md](02-架构设计文档.en.md) · [02-架构设计文档.ru.md](02-架构设计文档.ru.md) | Переводы архитектуры |
| UI и взаимодействие | [03-UI与交互设计文档.md](03-UI与交互设计文档.md) | Визуальная спецификация, макеты, компоненты, взаимодействие (китайский) |
|  | [03-UI与交互设计文档.en.md](03-UI与交互设计文档.en.md) · [03-UI与交互设计文档.ru.md](03-UI与交互设计文档.ru.md) | Переводы UI-документа |
